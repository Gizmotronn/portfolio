    ...
    class Redux_Options {
        ...
        */
        function __construct($sections = array(), $args = array(), $extra_tabs = array()) {    
            ...
            $defaults['footer_credit'] = sprintf(__('<span id="footer-thankyou">Thanks for using iSloping theme</span>', Redux_TEXT_DOMAIN), $this->framework_url, $this->framework_version);
