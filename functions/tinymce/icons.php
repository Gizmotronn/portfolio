<?php
echo '<optgroup label="Web Application Icons">
...
</optgroup><optgroup label="Text Editor Icons">
...
</optgroup><optgroup label="Directional Icons">
...
<option value="icon-circle">icon-circle</option>
<option value="icon-circle-blank">icon-circle-blank</option>
</optgroup><optgroup label="Video Player Icons">
...
</optgroup><optgroup label="Social Icons">
...
</optgroup><optgroup label="Medical Icons">
